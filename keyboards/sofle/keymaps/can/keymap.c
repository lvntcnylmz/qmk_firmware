...
[_RAISE] = LAYOUT(
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX, TR_GBRV,                        _______, _______,   KC_UP, KC_NXTWD,_______, _______,
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX, KC_CAPS,                       KC_WHOM,  KC_LEFT, KC_DOWN, KC_RGHT,  _______, _______,
  _______,KC_UNDO, KC_CUT, KC_COPY, KC_PASTE, XXXXXXX,  _______,       _______,  _______, KC_LSTRT, _______, KC_LEND,   KC_BSLS, _______,
                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
